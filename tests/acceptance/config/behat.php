...
return (new Config())
	->withProfile((new Profile('default', [
		...
		->withSuite((new Suite('apiImpersonate'))
			->addContext('ImpersonateAppContext')
			->addContext(
				'FeatureContext',
				$featureContextArgs
			)
			...
			->withPaths('%paths.base%/../features/apiImpersonate'))
		->withSuite((new Suite('webUIImpersonate'))
			->addContext('ImpersonateAppContext')
			->addContext(
				'FeatureContext',
				$featureContextArgs
			...
			->addContext('WebUIImpersonateContext')
			->withPaths('%paths.base%/../features/webUIImpersonate')));
